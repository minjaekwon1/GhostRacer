...
whiteLines::whiteLines(double line_X, double line_Y, StudentWorld* world, ghostRacer* racer)
	:actor(IID_WHITE_BORDER_LINE, line_X, line_Y, 0, 2.0, 2, true, false, -4, 0, world)
{
	car = racer;
}

yellowLines::yellowLines(double line_X, double line_Y, StudentWorld* world, ghostRacer* racer)
	: actor(IID_YELLOW_BORDER_LINE, line_X, line_Y, 0, 2.0, 2, true, false, -4, 0, world)
{
	car = racer;
}

void whiteLines::doSomething()
{
...
/*borderLines::borderLines(int line_ID, double line_X, double line_Y, StudentWorld* world)
	:actor(line_ID, line_X, line_Y, 0, 2.0, 2, true, false, -4, 0, world)
{
